                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo getLinkAdmin("contact_type","",['id'=>$item['id'],'view'=>'edit']); ?>"><?php echo $item['name']; ?></a> <a class="btn btn-danger btn-sm" style="padding: 0 5px;" href="<?php echo getLinkAdmin("contact_type","duplicate",['id'=>$item['id']]); ?>"> Nhân bản</a></td>
