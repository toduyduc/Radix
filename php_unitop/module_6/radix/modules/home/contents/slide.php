...
<section id="hero-area" class="hero-area">
	...
	<div class="slider-area">
		...
		?>
		<!-- Single Slider -->
		<div class="single-slider <?php echo (!empty($classItemSlide))?$classItemSlide:false;?>" style="background-image:url('<?php echo _WEB_HOST_TEMPLATES;?>/images/slider/slider-image1.jpg')">
			<div class="container">
				<div class="row">
					<?php
					$allowTwoCol = false;
					...
					<div class="col-lg-5 col-md-6 col-12">
						...
						<div class="image-gallery">
							...
							<div class="single-image"> <img src="<?php echo $item['slide_image_1']; ?>" alt="#"> </div>
							<?php endif;?>
							<?php if(!empty($item['slide_image_2'])): ?>
							<div class="single-image two"> <img src="<?php echo $item['slide_image_2'];?>" alt="#"> </div>
							<?php endif;?>
						</div>
						<!--/ End Image Gallery -->
					</div>
